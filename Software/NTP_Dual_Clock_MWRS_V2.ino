...
#define TZ_RULE   "AEST-10AEDT,M10.1.0,M4.1.0/3" // Australian Eastern Standard Time
...
// begin additions by KD5RXT 20250730
   ...
   if (SW2_state == BUTTON_MODE_ACTIVATED) {
   ...
   if ((brightness == 0) && ((millis() - check_light_sensor_interval) > CHECK_LIGHT_SENSOR_INTERVAL_IN_MILLIS)) {
      ...
      if (previous_bright_level != bright_level)
      {
